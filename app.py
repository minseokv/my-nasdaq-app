...
<style>
    ...
    /* [3] ★ 달력 네비게이션: 컬럼 시스템 강제 고정 ★ */
    /* 폰에서 세로로 쌓이는 것을 막기 위해 모든 하위 요소를 가로로 강제 정렬 */
    ...
    /* 일요일(1번째)과 토요일(3번째) 버튼 위치 확보 */
    div[data-testid="column"]:nth-of-type(1), 
    div[data-testid="column"]:nth-of-type(3) {
        flex: 0 0 50px !important; /* 버튼 폭 고정 */
    }
