...
<style>
    ...
    /* [★ 핵심 ★] 달력 버튼 폰에서도 무조건 한 줄로 고정 */
    /* 스트림릿의 기본 '세로 쌓기'를 원천 차단하는 가장 강력한 셀렉터입니다. */
    div[data-testid="column"] {
        min-width: 0px !important;
        flex: 1 1 0% !important;
    }
    
    /* 캘린더 네비게이션 영역만 따로 가로 정렬 강제 */
...
with col_main_L:
    ...
    # [수정] ★ cal-nav-area 구역에 강력한 가로 고정 규칙 적용 ★
